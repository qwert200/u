...
async def init():
    ...
    try:
        ...
        pass
    await Aliza.decorators()
    LOGGER("AlizaMusic").info("Aliza Music Bot Started Successfully")
    await idle()


if __name__ == "__main__":
    loop.run_until_complete(init())
    LOGGER("AlizaMusic").info("Stopping Aliza Music Bot! GoodBye")
