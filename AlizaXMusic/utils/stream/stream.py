...
import config
from AlizaXMusic import Carbon, YouTube, app
...
from AlizaXMusic.utils.exceptions import AssistantErr
from AlizaXMusic.utils.inline.play import (stream_markup,
                                          telegram_markup)
from AlizaXMusic.utils.inline.playlist import close_markup
from AlizaXMusic.utils.pastebin import Alizabin
from AlizaXMusic.utils.stream.queue import put_queue, put_queue_index
...
async def stream(
    ...
    if forceplay:
        await Aliza.force_stop_stream(chat_id)
